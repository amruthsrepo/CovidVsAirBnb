...
The data for both the sales and covid is very limited. So the accuracy of our model prediction was very less. So in the future, we can create synthetic data from the past data and can improve the accuracy.
